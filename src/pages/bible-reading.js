...
const SecondPage = () => (
  <Layout>
    ...
    <div>
      ...
      <p><strong>Purpose:</strong> To encourage a love of reading scripture as tool to learn more about Yahweh and to enrich our walks with Him individually and collectively.</p>
    </div>
  </div>
  <ModalButtons/>
  </div>
...
<Accordion>
    <Accordion.Item>
        <Accordion.Header>Saturday, June 29, 2024 - Hosea 11-13 / Hosea 14</Accordion.Header>
        <Accordion.Body>
...
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, June 22, 2024 - Hosea 7-9 / Hosea 10</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, June 15, 2024 - Hosea 3-5 / Hosea 6</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, June 8, 2024 - 2 Kings 18:1-8, Psalm 48, Hosea 1 / Hosea 2</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, June 1, 2024 - Isaiah 24-26 / Isaiah 27</Accordion.Header>
        <Accordion.Body>
...
<Accordion.Item eventKey="0">
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, May 25, 2024 - Isaiah 20-22 / Isaiah 23</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, May 18, 2024 - Isaiah 16-18 / Isaiah 19</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, May 11, 2024 - 2 Kings 17, Isaiah 13-14 / Isaiah 15</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, May 4, 2024 - Micah 5-7 / 2 Kings 16</Accordion.Header>
        <Accordion.Body>
...
<Accordion.Item eventKey="0">
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, April 27, 2024 - Micah 1-3 / Micah 4</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, April 20, 2024 - Isaiah 9-11 / Isaiah 12</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, April 13, 2024 - Amos 6-8 / Amos 9 (reassigned)</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, April 6, 2024 - Amos 6-8 / Amos 9</Accordion.Header>
        <Accordion.Body>
...
<Accordion.Item eventKey="0">
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, March 30, 2024 - Amos 2-4 / Amos 5</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, March 23, 2024 - Isaiah 6-8 / Amos 1</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, March 16, 2024 - Isaiah 2-4 / Isaiah 5</Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion>
<Accordion.Item eventKey="0">
        <Accordion.Header>Saturday, March 9, 2024 - Jonah 3-4, 2 Kings 15 / Isaiah 1</Accordion.Header>
        <Accordion.Body>
          ...
          <Accordion.Body><b>Roll over image to zoom in</b></Accordion.Body>
    ...
    <Accordion>
<Accordion.Item eventKey="0"><Accordion.Header>Saturday, March 2, 2024 - 2 Kings 13-14, Jonah 1</Accordion.Header><Accordion.Body><Link to="https://www.biblegateway.com/passage/?search=2+Kings+13-14%2C+Jonah+1&version=NLT;WEB;CJB" target="_blank">2 Kings 13-14, Jonah 1</Link><br/><Link to="https://www.biblegateway.com/passage/?search=Jonah%202&version=NLT;WEB;CJB" target="_blank">Read Together Jonah 2</Link><br/><br/>
    <Accordion.Body><b>Roll over image to zoom in</b></Accordion.Body>
<Accordion.Body id="img-zoomer-box">
  <img src="https://withgladness.com/wp-content/uploads/2024/01/18x24-300.jpg" id="img-1" alt="Chart of the Kings and Prophets of Israel and Judah by Josh Byers"/>
  <Accordion.Body id="img-2"></Accordion.Body>
   ...
   <a href="https://joshbyers.com/" target="_blank" rel="noreferrer">Design</a> by Josh Byers
    ...
    <Accordion>
<Accordion.Item eventKey="0"><Accordion.Header>February</Accordion.Header><Accordion.Body>

    <Accordion>
<Accordion.Item eventKey="0"><Accordion.Header>Saturday, February 24, 2024 - 2 Kings 13-14, Jonah 1 / Jonah 2</Accordion.Header><Accordion.Body><Link to="https://www.biblegateway.com/passage/?search=2+Kings+13-14%2C+Jonah+1&version=NLT;WEB;CJB" target="_blank">2 Kings 13-14, Jonah 1</Link><br/><Link to="https://www.biblegateway.com/passage/?search=Jonah%202&version=NLT;WEB;CJB" target="_blank">Read Together Jonah 2</Link><br/><br/>
    <Accordion.Body><b>Roll over image to zoom in</b></Accordion.Body>
    </Accordion.Body></Accordion.Item>
</Accordion>

    <Accordion>
<Accordion.Item eventKey="0"><Accordion.Header>Saturday, February 17, 2024 - 2 Kings 9-11 / 2 Kings 12</Accordion.Header><Accordion.Body><Link to="https://www.biblegateway.com/passage/?search=2+Kings+9-11&version=NLT;WEB;CJB" target="_blank">2 Kings 9-11</Link><br/><Link to="https://www.biblegateway.com/passage/?search=2%20Kings%2012&version=NLT;WEB;CJB" target="_blank">Read Together 2 Kings 12</Link>
    </Accordion.Body></Accordion.Item>
</Accordion>

    <Accordion>
<Accordion.Item eventKey="0"><Accordion.Header>Saturday, February 10, 2024 - 2 Kings 5-7 / 2 Kings 8</Accordion.Header><Accordion.Body><Link to="https://www.biblegateway.com/passage/?search=2+Kings+5-7&version=NLT;WEB;CJB" target="_blank">2 Kings 5-7</Link><br/><Link to="https://www.biblegateway.com/passage/?search=2%20Kings%208&version=NLT;WEB;CJB" target="_blank">Read Together 2 Kings 8</Link>
    </Accordion.Body></Accordion.Item>
</Accordion>


    <Accordion>
<Accordion.Item eventKey="0"><Accordion.Header>Saturday, February 3, 2024 - 2 Kings 5-7 / 2 Kings 8</Accordion.Header><Accordion.Body><Link to="https://www.biblegateway.com/passage/?search=2+Kings+5-7&version=NLT;WEB;CJB" target="_blank">2 Kings 5-7</Link><br/><Link to="https://www.biblegateway.com/passage/?search=2%20Kings%208&version=NLT;WEB;CJB" target="_blank">Read Together 2 Kings 8</Link>
    </Accordion.Body></Accordion.Item>
</Accordion>
    </Accordion.Body></Accordion.Item>
</Accordion>
    ...
    <Accordion>
<Accordion.Item eventKey="0"><Accordion.Header>January</Accordion.Header><Accordion.Body>
    <Accordion>
<Accordion.Item eventKey="0"><Accordion.Header>Saturday, January 27, 2024 - 2 Kings 1-3 / 2 Kings 4</Accordion.Header><Accordion.Body><Link to="https://www.biblegateway.com/passage/?search=2+Kings+1-3&version=NLT;WEB;CJB" target="_blank">2 Kings 1-3</Link><br/><Link to="https://www.biblegateway.com/passage/?search=2%20Kings%204&version=NLT;WEB;CJB" target="_blank">Read Together 2 Kings 4</Link>
    </Accordion.Body></Accordion.Item>
</Accordion>


    <Accordion>
<Accordion.Item eventKey="0"><Accordion.Header>Saturday, January 20, 2024 - 1 Kings 22, Obadiah, Psalm 82 / Psalm 83</Accordion.Header><Accordion.Body><Link to="https://www.biblegateway.com/passage/?search=1+Kings+22%2C+Obadiah%2C+Psalm+82&version=NLT;WEB;CJB" target="_blank">1 Kings 22, Obadiah, Psalm 82</Link><br/><Link to="https://www.biblegateway.com/passage/?search=psalm+83&version=NLT;WEB;CJB" target="_blank">Read Together Psalm 83</Link>    </Accordion.Body></Accordion.Item>
</Accordion>

    <Accordion>
<Accordion.Item eventKey="0"><Accordion.Header>Saturday, January 13, 2024 - 1 Kings 18-20 / 1 Kings 21</Accordion.Header><Accordion.Body><Link to="https://www.biblegateway.com/passage/?search=1+Kings+18-20&version=NLT;WEB;CJB" target="_blank">1 Kings 18-20</Link><br/><Link to="https://www.biblegateway.com/passage/?search=1%20Kings%2021&version=NLT;WEB;CJB" target="_blank">Read Together 1 Kings 21</Link></Accordion.Body></Accordion.Item>
</Accordion>
